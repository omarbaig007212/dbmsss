          ...
          <div class="col-md-3 student-grid">
			<?php
				...
				$results1=0;
					...
					$aad=$_GET["aad"];
					$passwd=$_GET["passwd"];
					$sql = "SELECT first_name,middle_name,last_name,dob,img FROM citizen where aadhar=$aad";
					...
					if (mysqli_num_rows($result) > 0) {
						...
						while($row = mysqli_fetch_assoc($result)) {
							...
							echo ' <p>&emsp; &emsp; Image :  <img src="data:image/jpeg;base64,'.base64_encode($row["img"] ).'"height="200" width="200" class="img1" />'; 
							$dob=$row["dob"];  
					   		}
					}
					else {
      ...
      <div class="footer-grids">
        ...
        <h4>Information</h4>
          <ul>
            ...
            <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:karnataka@rto.com"> example@rto.com</a></li>
